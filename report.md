...
> 这份是**提纲 + 中文写作提示**——帮你组织思路；**英文句子你自己打**（GenAI 规则 + oral 面谈）。
...
**R1 封面**：标题 · 全名 · 学号 · **GenAI 声明一字不差**：
> *"I have not used any GenAI tools in creating, analysing, or writing this assessment. I have used [填 Claude] for bug fixing of scripts."*
（缺了或改了意思不清 = **全卷 0 分**，这是唯一的死线。）
